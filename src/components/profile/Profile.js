                            ...
                            <div className="row">
                                <div className="col-4">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control form-control-sm" value="Ariane"/>
                                    </div>
                                </div>
                                <div className="col-4">
                                    <div className="form-group">
                                        <label className="mb-2">Last Name</label>
                                        <input type="text" className="form-control form-control-sm" value="Gerona"/>
                                    </div>
                                </div>
                                <div className="col-4">
                                    <div className="form-group">
                                        <label className="mb-2">Email</label>
                                        <input type="text" className="form-control form-control-sm" value="Ariane@gmail.com" readOnly/>
                                    </div>
                                </div>
                                <div className="col-4">
                                    <div className="form-group">
