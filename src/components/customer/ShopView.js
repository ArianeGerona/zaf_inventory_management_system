                    ...
                    <form>
                        <div className="container-fluid">
                            <div className="row">
                                ...
                                <div className="col-6">
                                    <InputFormGroup inputClassName="form-control" labelClassName="mb-2" isReadOnly={true} value="Ariane" label="First Name" />
                                </div>
                                <div className="col-6">
                                    <InputFormGroup inputClassName="form-control" labelClassName="mb-2" isReadOnly={true} value="Gerona" label="Last Name" />
                                </div>
                                <div className="col-6">
                                    <InputFormGroup inputClassName="form-control" labelClassName="mb-2" isReadOnly={true} value="Ariane@gmail.com" label="Email" />
                                </div>
                                <div className="col-6">
                                ...
                                <div className="col-6">
                                    <InputFormGroup inputClassName="form-control" labelClassName="mb-2" isReadOnly={true} value="25" label="Total Employees" />
                                </div>
                                <div className="col-6">
